    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                {
                    options.Authority = "https://securetoken.google.com/campgroundsapp";
                    options.TokenValidationParameters = new TokenValidationParameters
                    {
                        ValidateIssuer = true,
                        ValidIssuer = "https://securetoken.google.com/campgroundsapp",
                        ValidateAudience = true,
                        ValidAudience = "campgroundsapp",
                        ValidateLifetime = true
                    };
                });
            services.AddPersistence(Configuration);
            services.AddSingleton<ICampgroundService, CampgroundService>();
